...
jQuery(function ($) {
    (function (d, wrapper, h, interactions, t) {
            ...
            if (form_id == h.form_id) {
                switch (parseInt(current_page)) {
                    ...
                    case 2:
                        ...
                        formcontroller.initcalendarpicker(field_body, h.ff_expectdate);
                        formcontroller.initcalendartimepicker(field_body, h.ff_expectedtime);
                        break;
                    case 3:
        ...
        formcontroller.initcalendarpicker = function (body, field_id) {
            //  console.log("check and see initcalendarpicker");
            //  console.log(settings_p1);
            var settings_p1 = $.extend({}, basic_settings, {timepicker: false, format: 'Y/m/d'});
            $(field_id).datetimepicker(settings_p1);
        }
        formcontroller.initcalendartimepicker = function (body, field_id) {
            //  console.log("check and see initcalendartimepicker");
            //  console.log(settings_p2);
            var settings_p2 = $.extend({}, basic_settings, {datepicker: false, format: 'H:i'});
            $(field_id).datetimepicker(settings_p2);
        }
