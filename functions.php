...
require(get_template_directory() . '/hkm/ini.php');
...
function twentytwelve_setup()
{
    ...
    register_nav_menu('rightmenu', __('Right Menu', 'twentytwelve'));
    /*
...
function twentytwelve_widgets_init()
{
    ...
    register_sidebar(array(
        ...
        'id' => 'footerwdge',
        'description' => __('This will be shown on the bottom of the footer', 'twentytwelve'),
        'before_widget' => '<aside id="%1$s" class="widget %2$s">',
        'after_widget' => '</aside>',
