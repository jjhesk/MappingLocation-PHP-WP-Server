<div class="editorbar">
    ...
    <input onclick="edit_current_template()" type="button" value="edit" class="button"/>
    <input onclick="red_frame_toggle()" type="button" value="view guide" class="button"/>
</div>
<div class="book">
...
<script id="_single_photo_cell_layout" type="text/x-handlebars-template">
    <td>
        <div class="photo"><img src="{{src_url}}"/></div>
        <span class="caption">{{tag}} {{description}}</span>
    </td>
</script>
