...
//VALIDATION
jQuery(document).ready(function() {
	jQuery("#wp-admin-bar-wp-logo .ab-sub-wrapper").html("");
	jQuery("#welcome-panel").remove();
	jQuery("#dashboard-widgets-wrap").prepend("<img width='100%' src='http://linker.imusictech.com/wp-content/themes/linkr/images/logo_600x200.png'/>");
