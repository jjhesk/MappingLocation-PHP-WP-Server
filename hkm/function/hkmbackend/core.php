...
//fb($_POST);
//	  $plugin_base_path = trailingslashit(plugins_url(basename(dirname(__FILE__))));
//	  $plugin_base_path = get_template_directory_uri()."/hkm/function/hkmbackend/";


class HKM_BACKEND_AG{
	private $colorizer="";	
	...
	function agca_get_includes() {
      global $user_level;
       ?><script type="text/javascript"><?php 
                                //AGCA GLOBALS                            
       echo "var agca_global_plugin_url = '".HKMBACKEND_PATH."';"; 
       ?></script>
       <link rel="stylesheet" type="text/css" href="<?=HKMBACKEND_PATH;?>style/ag_style.css?ver=<?php echo $this->agca_version; ?>" />                       
			<script type="text/javascript" src="<?=HKMBACKEND_PATH; ?>script/ag_script.js?ver=<?php echo $this->agca_version; ?>"></script>	                        	
                       <?php
	...
	?><script type="text/javascript" src="<?php echo get_bloginfo('wpurl'); ?>/wp-includes/js/jquery/jquery.js"></script><?php		
	}
	function agca_register_settings() {	
		register_setting( 'hkm-options-group', 'agca_role_allbutadmin' );
		register_setting( 'hkm-options-group', 'agca_screen_options_menu' );
		register_setting( 'hkm-options-group', 'agca_help_menu' );
		register_setting( 'hkm-options-group', 'agca_logout' );
		register_setting( 'hkm-options-group', 'agca_remove_your_profile' );
		register_setting( 'hkm-options-group', 'agca_logout_only' );
		register_setting( 'hkm-options-group', 'agca_options_menu' );
		register_setting( 'hkm-options-group', 'agca_howdy' );
		register_setting( 'hkm-options-group', 'agca_header' );
		register_setting( 'hkm-options-group', 'agca_header_show_logout' );		
		register_setting( 'hkm-options-group', 'agca_footer' );
		register_setting( 'hkm-options-group', 'agca_privacy_options' );
		register_setting( 'hkm-options-group', 'agca_header_logo' );
		register_setting( 'hkm-options-group', 'agca_header_logo_custom' );
		register_setting( 'hkm-options-group', 'agca_wp_logo_custom' );
        register_setting( 'hkm-options-group', 'agca_wp_logo_custom_link' );
		register_setting( 'hkm-options-group', 'agca_site_heading' );
		register_setting( 'hkm-options-group', 'agca_custom_site_heading' );
		register_setting( 'hkm-options-group', 'agca_update_bar' );
		register_setting( 'hkm-options-group', 'agca_footer_left' );
		register_setting( 'hkm-options-group', 'agca_footer_left_hide' );		
		register_setting( 'hkm-options-group', 'agca_footer_right' );
		register_setting( 'hkm-options-group', 'agca_footer_right_hide' );
		register_setting( 'hkm-options-group', 'agca_login_banner' );
		register_setting( 'hkm-options-group', 'agca_login_banner_text' );
		register_setting( 'hkm-options-group', 'agca_login_photo_remove' );
		register_setting( 'hkm-options-group', 'agca_login_photo_url' );
		register_setting( 'hkm-options-group', 'agca_login_photo_href' );
        register_setting( 'hkm-options-group', 'agca_login_round_box' );
		register_setting( 'hkm-options-group', 'agca_login_round_box_size' );		
		register_setting( 'hkm-options-group', 'agca_dashboard_icon' );
		register_setting( 'hkm-options-group', 'agca_dashboard_text' );
		register_setting( 'hkm-options-group', 'agca_dashboard_text_paragraph' );
        register_setting( 'hkm-options-group', 'agca_dashboard_widget_welcome' );
		register_setting( 'hkm-options-group', 'agca_dashboard_widget_rc' );	
		register_setting( 'hkm-options-group', 'agca_dashboard_widget_il' );	
		register_setting( 'hkm-options-group', 'agca_dashboard_widget_plugins' );	
		register_setting( 'hkm-options-group', 'agca_dashboard_widget_qp' );	
		register_setting( 'hkm-options-group', 'agca_dashboard_widget_rn' );	
		register_setting( 'hkm-options-group', 'agca_dashboard_widget_rd' );	
		register_setting( 'hkm-options-group', 'agca_dashboard_widget_primary' );	
		register_setting( 'hkm-options-group', 'agca_dashboard_widget_secondary' );	
		//WP3.3
		register_setting( 'hkm-options-group', 'agca_admin_bar_comments' );
		register_setting( 'hkm-options-group', 'agca_admin_bar_new_content' );
		register_setting( 'hkm-options-group', 'agca_admin_bar_new_content_post' );
		register_setting( 'hkm-options-group', 'agca_admin_bar_new_content_link' );
		register_setting( 'hkm-options-group', 'agca_admin_bar_new_content_page' );
		register_setting( 'hkm-options-group', 'agca_admin_bar_new_content_user' );
		register_setting( 'hkm-options-group', 'agca_admin_bar_new_content_media' );		
		register_setting( 'hkm-options-group', 'agca_admin_bar_update_notifications' );	
		register_setting( 'hkm-options-group', 'agca_remove_top_bar_dropdowns' );
		/*Admin menu*/
		register_setting( 'hkm-options-group', 'agca_admin_menu_turnonoff' );	
		register_setting( 'hkm-options-group', 'agca_admin_menu_agca_button_only' );	
		register_setting( 'hkm-options-group', 'agca_admin_menu_separator_first' );	
		register_setting( 'hkm-options-group', 'agca_admin_menu_separator_second' );	
		register_setting( 'hkm-options-group', 'agca_admin_menu_icons' );	
        register_setting( 'hkm-options-group', 'agca_admin_menu_arrow' );
        register_setting( 'hkm-options-group', 'agca_admin_menu_submenu_round' );	
        register_setting( 'hkm-options-group', 'agca_admin_menu_submenu_round_size' );
        register_setting( 'hkm-options-group', 'agca_admin_menu_brand' );
        register_setting( 'hkm-options-group', 'agca_admin_menu_brand_link' );                
		register_setting( 'hkm-options-group', 'ag_edit_adminmenu_json' );
		register_setting( 'hkm-options-group', 'ag_add_adminmenu_json' );	
		register_setting( 'hkm-options-group', 'ag_colorizer_json' );	
		register_setting( 'hkm-options-group', 'agca_colorizer_turnonoff' );                
        register_setting( 'hkm-options-group', 'agca_custom_js' );
        register_setting( 'hkm-options-group', 'agca_custom_css' );
        if(!empty($_POST)){
                 // fb($_POST);
                    if(isset($_POST['_agca_import_settings']) && $_POST['_agca_import_settings']=="true"){                            
                            if(isset($_FILES) && isset($_FILES['settings_import_file']) ){
                                if($_FILES["settings_import_file"]["error"] > 0){                                  
                                    ...
                                    if($this->startsWith($file['name'],'hkm_Settings_')){  
    ...
    function getOptions(){
        ...
        function exportSettings(){
            ...
            foreach ($_POST as $key => $value) {
             ...
             $filename = 'hkm_Settings_'.date("Y-M-d_H-i-s").'.hkmbackend';             
	...
	//create new top-level menu		
		//add_management_page( 'HKM Custom', 'HKM Backend', 'administrator', __FILE__, array(&$this,'agca_admin_page') );
		//add_theme_page('HKM Custom', 'HKM Backend', 'administrator', __FILE__, array(&$this,'agca_admin_page'));
	add_theme_page(
	'HKM Custom',
	 'HKM Backend',
	  'administrator',
	   "hkm-backend-options",
	    array(&$this,'agca_admin_page')
		);
	}
	...
	function print_page()
	{
		...
		?>
                 ...
                 <script type="text/javascript">      
                    ...
                    initJQuery();                  
<?php 
echo "var agca_global_plugin_url = '".HKMBACKEND_PATH."';"; ?></script>
<script type="text/javascript" src="<?=HKMBACKEND_PATH ?>script/ag_script.js?ver=<?php echo $this->agca_version; ?>"></script><?php
	}
...
jQuery('#ag_add_adminmenu').append(buttonsJq); 	
	...
	errors = "HKM BACKEND - ADMIN ERROR: " + err.name + " / " + err.message;
	alert(errors);		
 }finally{
	jQuery('html').css('visibility','visible');	
	if(errors){
		jQuery("#agca_form").html('<div style="height:500px"><p style="color:red"><strong>WARNING:</strong> HKM BACKEND Admin stops its execution because of an error. Please resolve this error before continue: <br /><br /><strong>' + errors + '</strong></p></div>');
	}	
 }  
 <?php
 ...
 /* ]]> */ 
	...
	?><script type="text/javascript">
        ...
        /* <![CDATA[ */
            jQuery(document).ready(function() {			
				try{ <?php if(get_option('agca_login_round_box')==true){ ?>
					...
					jQuery("#backtoblog").html('<?php 
							$k = wpautop(get_option('agca_login_banner_text')); 
							echo preg_replace("/[\n\r]/","",$k);
							?>');
					<?php } ?>
					<?php if(get_option('agca_login_photo_url')==true){ ?>								
							...
							jQuery("#login h1 a").css("background", url+' no-repeat 0 0');	
				...
				alert("HKM BACKEND - LOGIN ERROR: " + err.name + " / " + err.message);							
			 }finally{				
	...
	function agca_admin_page() {
		...
		$wpversion = $this->get_wp_version();
		?>		
		<?php //includes ?><link rel="stylesheet" type="text/css" href="<?=HKMBACKEND_PATH ?>style/farbtastic.css" /><script type="text/javascript" src="<?=HKMBACKEND_PATH ?>script/farbtastic.js"></script><link rel="stylesheet" type="text/css" href="<?=HKMBACKEND_PATH ?>style/agca_farbtastic.css" />
		<script type="text/javascript" src="<?=HKMBACKEND_PATH ?>script/agca_farbtastic.js"></script>
		<script type="text/javascript">
		var isAGCAPage = true;</script>
		<?php //includes ?>		
		<div class="wrap"><h1 style="color:green">HKM BACKEND CUSTOMIZATION<span style="font-size:15px;">(v<?php echo $this->agca_version; ?>)</span></h1><div id="agca_news">&nbsp;</div><br />								
<form method="post" id="agca_form" action="options.php">
<?php settings_fields( 'hkm-options-group' ); ?>
<table><tr valign="center" ><th scope="row"><label title="If checked, all users will be affected with these changes, except admin. Not checked = apply for all" for="agca_role_allbutadmin">Do not apply these settings for Admin&nbsp;&nbsp;</label></th><td><input title="If checked, all users will be affected with these changes, except admin. Not checked = apply for all" type="checkbox" name="agca_role_allbutadmin" value="true" <?php if (get_option('agca_role_allbutadmin')==true) echo 'checked="checked" '; echo get_option('agca_role_allbutadmin'); ?> />								
								</td>
				</tr> 
			</table>
			<br />
			<ul id="ag_main_menu">
				...
				<h2 class="section_title" >Admin Bar Settings Page</h2>
				<br />
					<p ><i><strong>Info: </strong>Roll over option labels for more information about option.</i></p>							
				<br />
				<table class="form-table" width="500px">							
						...
						<div id="section_admin_footer" style="display:none" class="ag_section">	
							<h2 class="section_title" >Admin Footer Settings Page</h2>
							<br /><br />						
							<table class="form-table" width="500px">		
							<tr valign="center" class="ag_table_major_options">
								<td>
						...
						<h2 class="section_title" >Admin Menu Settings Page</h2>
						<br />
						<p style="font-style:italic" ><strong>Important: </strong>Please Turn off menu configuration before activating or disabling other plugins (or making any other changes to main menu). Use "Reset Settings" button to restore default values if anything goes wrong.</p>					
						<br />
							<table class="form-table" width="500px">	
							<tr valign="center" class="ag_table_major_options">
							...
							<tr>
								...
								Reset to default values
											...
											<p ><em>(click on menu link to show/hide its submenus below it)</em></p>
						...
						<table class="form-table" width="500px">	
							...
							<tr valign="center">
								<td colspan="2">
										<div class="ag_table_heading"><h3 >Global Color Options</h3></div>
								</td>
								<td>									
								</td>
							</tr>
							...
							<tr valign="center">
								<td colspan="2">
										<div class="ag_table_heading"><h3 >Admin Menu Color Options</h3></div>
								</td>
								<td>									
								</td>
							</tr>
							...
							<tr valign="center">
								<td colspan="2">
										<div class="ag_table_heading"><h3 >Font Color Options</h3></div>
								</td>
								<td>									
								</td>
							</tr>
							...
							<tr valign="center">
								<td colspan="2">
										<div class="ag_table_heading"><h3 >Widgets Color Options</h3></div>
								</td>
								<td>									
								</td>
							</tr>
                                                                        ...
                                                                        <br />
                                                                                ...
                                                                                <table class="form-table" width="500px">
                                                                                    <tr valign="center">
                                                                                            ...
                                                                                            <td>
                                                                                            <textarea title="Add custom CSS script to override existing styles" rows="5" id="agca_custom_css"  name="agca_custom_css" cols="40"><?php echo htmlspecialchars(get_option('agca_custom_css')); ?></textarea>
                                                                                            </td>
                                                                                    </tr>	
                                                                                    <tr valign="center">
                                                                                            <th scope="row">
                                                                                            ...
                                                                                            <td>
                                                                                            <textarea title="Add additional custom JavaScript" rows="5" name="agca_custom_js"  id="agca_custom_js" cols="40"><?php echo htmlspecialchars(get_option('agca_custom_js')); ?></textarea>
                                                                                            </td>
                                                                                    </tr>
                                                                                     <tr valign="center">
                                                                                            <th scope="row">
...
<br /><p id="agca_footer_support_info">For further support please visit www.hkmdev.wordpress.com</p><br />
		<?php
	}
}
?>