...
class submission extends submission_basic
{
    //enum  machine_data
    //      basemap
    //      sitephoto
    //      sign
    private $uploaded_return_id, $job_id, $post_title, $post_content, $submission_nature, $post_content2;
    ...
    private function control_media_upload($post_id)
    {
