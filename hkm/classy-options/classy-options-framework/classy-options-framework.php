...
define('CLASSY_OPTIONS_FRAMEWORK_URL', get_template_directory_uri() . '/hkm/classy-options/classy-options-framework/');
define('CLASSY_OPTIONS_FRAMEWORK_IMG', CLASSY_OPTIONS_FRAMEWORK_URL . 'images/');
define('CLASSY_OPTIONS_FRAMEWORK_CSS', CLASSY_OPTIONS_FRAMEWORK_URL . 'css/');
define('CLASSY_OPTIONS_FRAMEWORK_JS', CLASSY_OPTIONS_FRAMEWORK_URL . 'js/');
/* Make sure we don't expose any info if called directly */

if (!function_exists('add_action')) {
    exit ;
}
require_once dirname(__FILE__) . DIRECTORY_SEPARATOR . 'response-meta.php';
