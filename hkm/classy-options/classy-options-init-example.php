...
require( get_template_directory() . '/hkm/classy-options/classy-options-framework/classy-options-framework.php');
...
TEMPLATE_URL . '/images/social/thumbs/icons-default.png' ), 'default' => 'default' ) )
		...
		->subsection_end()->subsection("API")
			->text($ec_themeslug."_google_api_key", "Google API key")
			->checkbox($ec_themeslug."_hide_googleapi", "Do not use Google API key" , array('default' => true))
			->text($ec_themeslug."_hide_fb_app_id", "FACEBOOK APP ID")
			->checkbox($ec_themeslug."_fb_app_id", "Hide YouTube Icon",array('default' => true))
		->subsection_end()
	->section("Blog")
