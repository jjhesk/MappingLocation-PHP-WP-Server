...
function enqueue_store_styles() {
 	...
 	wp_register_style($ec_themeslug.'storecss', get_template_directory_uri(). '/core/classy-options/themes.css');

      
    wp_enqueue_style($ec_themeslug.'storecss');  
}
...
<div id="contain">
	<div id="themesheader">
		<a href="http://cyberchimps.com" target="_blank"><img src="<?php echo $ec_root ;?>/images/themes/cyberchimps.png" /></a>
		<br />
	...
	<div class="theme_images">
		<a href="http://cyberchimps.com/ifeaturepro/" target="_blank"><img src="<?php echo $ec_root ;?>/images/themes/ifeaturepro.png" /></a>
	</div>
	...
	<div class="theme_images">
		<a href="http://cyberchimps.com/businesspro/" target="_blank"><img src="<?php echo $ec_root ;?>/images/themes/bizpro.png" /></a>
	</div>
	<div class="theme_desciptions">
	...
	<div class="theme_images">
		<a href="http://cyberchimps.com/responsepro/" target="_blank"><img src="<?php echo $ec_root ;?>/images/themes/responsepro.png" /></a>
	</div>
	<div class="theme_desciptions">
	...
	<div class="theme_images">
		<a href="http://cyberchimps.com/neuropro/" target="_blank"><img src="<?php echo $ec_root ;?>/images/themes/neuropro.png" /></a>
	</div>
	<div class="theme_desciptions">
